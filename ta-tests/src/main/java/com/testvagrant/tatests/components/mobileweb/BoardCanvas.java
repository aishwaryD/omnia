...
import com.testvagrant.tatests.components.model.mobileweb.IBoardCanvas;
...
public class BoardCanvas extends MWebBaseComponent implements IBoardCanvas {
    ...
    private final String task = "//div[contains(@class,'list js-list-content')]//h2[contains(@class,'js-list-name-assist') and contains(text(),'%s')]//ancestor::div[contains(@class,'is-menu-shown')]//following-sibling::div[contains(@class,'js-list-cards')]//span[contains(@class,'js-card-name') and text()='%s']";
    ...
    public int getAllTasks(String listTitle)
    {
